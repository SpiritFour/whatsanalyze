  ...
  <div>
    <div v-if="attachment" class="media-style">
      ...
      <audio
        ...
        :title="attachment.fileName"
      />
      <div v-else align="center" class="rando-file-container">
        <div class="ma-0 pa-0 pr-3" style="position: relative" cols="2">
          <div justify="center">
        ...
        <div class="ma-auto pl-0 pr-2 py-1" align="left" cols="10">
          <div
            class="caption"
            style="
              white-space: nowrap;
