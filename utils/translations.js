export const messages = {
  en: {
    ...
    averageResponseTimeFor: "{name}",
    noDataAvailable: "No data available",
    responseTimeHours:
      "{hours} hours, {minutes} minutes, and {seconds} seconds",
    responseTimeMinutes: "{minutes} minutes and {seconds} seconds",
    responseTimeSeconds: "{seconds} seconds",
  ...
  de: {
    ...
    responseTimeMinutes: "{minutes} Minuten und {seconds} Sekunden",
    responseTimeSeconds: "{seconds} Sekunden",
  ...
  es: {
    ...
    responseTimeHours: "{hours} horas, {minutes} minutos y {seconds} segundos",
    responseTimeMinutes: "{minutes} minutos y {seconds} segundos",
    responseTimeSeconds: "{seconds} segundos",
  ...
  pt: {
    ...
    averageResponseTime: "Tempo de Resposta Médio",
    averageResponseTimeFor: "{name}",
    noDataAvailable: "Nenhum dado disponível",
    responseTimeHours: "{hours} horas, {minutes} minutos e {seconds} segundos",
    responseTimeMinutes: "{minutes} minutos e {seconds} segundos",
    responseTimeSeconds: "{seconds} segundos",
  ...
  fr: {
    ...
    responseTimeMinutes: "{minutes} minutes et {seconds} secondes",
    responseTimeSeconds: "{seconds} secondes",
