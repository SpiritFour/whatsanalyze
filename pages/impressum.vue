<template>
  <div>
    <LandingHero
      ...
      title="Impressum"
      subtitle="Imprint & privacy policy"
    />
    <section class="impressum-surface">
      <v-container>
        <div class="impressum">
          <!-- The imprint and the privacy policy are the legally binding
               German originals (§ 5 TMG, DSGVO); only the terms of service
               are in English. Say so, rather than leaving an English reader
               wondering why the page switched language. -->
          <p class="impressum__lang-note">{{ $t("impressumLanguageNote") }}</p>
          ...
          <p>
            ...
            E-Mail:
            <a href="mailto:info@whatsanalyze.com">info@whatsanalyze.com</a
            ><br />
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            use of WhatsAnalyze's website, located at whatsanalyze.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use whatsanalyze.com if you do not
          ...
          <p>
            We employ the use of cookies. By accessing whatsanalyze.com, you
            agreed to use cookies in agreement with the Whatsanalyze's Privacy
            Policy.
          </p>
          ...
          <p>
            ...
            intellectual property rights for all material on whatsanalyze.com.
            All intellectual property rights are reserved. You may access this
            from whatsanalyze.com for your own personal use subjected to
          ...
          <p>
            ...
            Whatsanalyze does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Whatsanalyze,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws,
            Whatsanalyze shall not be liable for the Comments or for any
          ...
          <p>
            Whatsanalyze reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Whatsanalyze a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Whatsanalyze;
          ...
          <p>
            ...
            sending an e-mail to Whatsanalyze. Please include your name, your
        ...
        <div>
          ...
          <p>
            ...
            Campus, Dublin 24, Republic of Ireland; nachfolgend „Adobe“), der
            uns den Zugriff auf eine Schriftartenbibliothek gewährt.
          </p>
          <p>
          ...
          <p>
            ...
            wollen, widerrufen Sie bitte im Cookie-Consent-Tool Ihre
            Einwilligung für die entsprechende Cookie-Kategorie oder alle
          ...
          <p>
            ...
            ermöglichen Ihnen die komfortable Nutzung der Karten-Funktion.<br />Nähere
          ...
          <p>
            Durch den Besuch der Website erhält Google Informationen, dass Sie
          ...
          <p>
            ...
            Einstellungsmöglichkeiten zum Schutze Ihrer Privatsphäre (<a
              href="https://policies.google.com/privacy"
              >https://policies.google.com/privacy</a
            >).
          </p>
          ...
          <p>
            ...
            LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA. Sind
            Sie über eine von Google geschaltete Anzeige auf unsere Webseite
            ...
            Nutzer auf eine von Google geschaltete Anzeige klickt.
          </p>
          <p>
            ...
            Cookie. Cookies können somit nicht über die Websites von
          ...
          <p>
            ...
            dieser Webseiten aufruft, die dem Werbenetzwerk von Google
            angehören. Auf diesen Seiten können dem Besucher Werbeanzeigen
...
// Same light surface as every other section, below the dark hero — the page
// used to butt raw white straight up against the dark sticky header.
.impressum-surface {
...
.impressum {
  ...
  :deep(hr) {
    border: none;
    border-top: 1px solid $wa-border;
    margin: 2.5rem 0;
  }
}
</style>
