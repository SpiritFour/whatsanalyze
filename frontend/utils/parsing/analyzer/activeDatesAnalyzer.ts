import type { Message, ActiveDates } from '../types';

export class ActiveDatesAnalyzer {
    static getISOWeekNumber(dateObj: Date): string {
    ...
    static getActiveDates(messages: Message[]): ActiveDates {
        ...
        for (const message of messages) {
            ...
            const weekKey = ActiveDatesAnalyzer.getISOWeekNumber(d);
