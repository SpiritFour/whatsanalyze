import type { Message, WordUsageAnalysis, AuthorStats, WordUsageStats } from '../types';
...
export class WordUsageAnalyzer {
  static getRelativeWordUsage(messages: Message[]): WordUsageAnalysis {
    ...
    const resultByAuthor: Record<string, {
